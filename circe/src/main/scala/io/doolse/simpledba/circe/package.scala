...
package object circe {
  ...
  def circeIso[A : Encoder : Decoder](default: A): Iso[A, Option[String]] = new Iso[A, Option[String]](
  ...
  def circeIsoUnsafe[A : Encoder : Decoder]: Iso[A, String] = new Iso[A, String](
    _.asJson.noSpaces, s => decode[A](s).fold(throw _, identity)
  )

  def circeIsoNonNull[A : Encoder : Decoder](default: A): Iso[A, String] = new Iso[A, String](
    _.asJson.noSpaces, s => decode[A](s).getOrElse(default)
  )
}
