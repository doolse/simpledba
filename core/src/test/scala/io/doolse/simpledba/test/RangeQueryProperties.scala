...
abstract class RangeQueryProperties[F[_] : Monad : Catchable](implicit rangeable: Arbitrary[Rangeable],
  ...
  case class Queries[F[_]](writes: WriteQueries[F, Rangeable],
                           ...
                           int2: RangeQuery[F, Rangeable, UUID, (Int, String)],
                           string1: RangeQuery[F, Rangeable, UUID, String],
                           string2: RangeQuery[F, Rangeable, UUID, (String, Short)],
  ...
  def checkRange[A](same: UUID, v: Vector[Rangeable], _range: FilterRange[Rangeable], rangeQ: Seq[(String, RangeCheck[_])]) = {
  ...
  property("Range by int") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
  ...
  property("Range by string") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
  ...
  property("Range by short") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
  ...
  property("Range by long") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
  ...
  property("Range by float") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
  ...
  property("Range by double") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
  ...
  property("Range by uuid") = forAll { (l: Vector[Rangeable], range: FilterRange[Rangeable]) =>
    checkRange(UUID.randomUUID, l, range, Seq(
